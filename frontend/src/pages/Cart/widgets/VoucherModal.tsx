    ...
    <div className="fixed inset-0 z-50 bg-gray-600 bg-opacity-50 flex justify-center items-center">
      <div className="bg-white rounded-xl w-[36%] max-h-[100dvh] overflow-y-auto custom-scrollbar relative">
        <div className="max-w-[540px] m-auto">
          <h2 className="text-xl font-bold w-full text-center border-solid border-b-2 py-[17px]">
            Vimall khuyến mãi
          </h2>
          <div
            ...
            <div className="py-4 flex justify-between">
              <div className="flex gap-2 items-center w-[75%] border-solid border-2 rounded-[32px] py-2 px-4">
                ...
                <input
                  ...
                  className="outline-none text-[14px] w-[80%]"
                />
              </div>
              <div className="bg-bg-alt1 center rounded-[32px] text-white text-[14px] font-medium w-[23%] py-2 cursor-pointer">
                Áp dụng
              </div>
            </div>
