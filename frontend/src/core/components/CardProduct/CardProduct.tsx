...
const CardProduct: React.FC<CardProductProps> = ({ product, widthConfig = 'default' }) => { 
  ...
  return (
    <div className={`${widthClasses} bg-slate-100 overflow-hidden rounded-[16px] p-4 flex flex-col gap-[10px] relative group cursor-pointer`}>
