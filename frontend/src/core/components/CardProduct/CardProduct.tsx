...
const CardProduct: React.FC<CardProductProps> = ({ product, widthConfig = 'default' }) => { 
  ...
  return (
    <div className={`${widthClasses} m-auto sm:m-0 bg-slate-100 overflow-hidden rounded-[16px] p-4 flex flex-col gap-[10px] relative group cursor-pointer`}>
        ...
        <div><img src={product1} className={`w-full ${widthConfig === 'carousel' ? 'h-[190px]' : 'aspect-square'} rounded-[8px] object-cover`}></img></div>
