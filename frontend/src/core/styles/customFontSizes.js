// Thiết lập cỡ chữ cho toàn bộ website

module.exports = {
    category: '18px',          // Font cho danh mục
    subCategory: '14px',          // Font cho danh mục con
    ...
    footerTitle: '1.125rem',   // Font cho tiêu đề trong footer
    headingText: '32px',         // Font cho tiêu đề (h1, h2,...)
    subHeadingText: '1.25rem',     // Font cho các tiêu đề phụ (h3, h4,...)
    small: '11px',
    'super-small': '10px',
  };
